...
const PricingBreakdown: React.FC = () => {
  const sections = [
    ...
    },
    {
      ...
      subtotal: { htAmount: "12 411,00 €", tva: "2 482,20 €", ttcAmount: "14 893,20 €" }
    },
    {
    ...
    },
    {
      ...
      rows: [
        ...
        { title: "Portail standard", htAmount: "1 968,75 €", tva: "393,75 €", ttcAmount: "2 362,50 €" },
        { title: "Terrasse (25 m²)", htAmount: "5 075,00 €", tva: "1 015,00 €", ttcAmount: "6 090,00 €" },
      ],
            ...
            <table className="w-full min-w-[600px]">
              ...
              <tbody>
                <tr className="bg-gray-100/50">
                  ...
                  <td className="px-1 sm:px-4 py-3 sm:py-4 text-right text-gray-900 font-mono font-bold text-sm sm:text-lg whitespace-nowrap">332 725,52 €</td>
                  <td className="px-1 sm:px-4 py-3 sm:py-4 text-right text-gray-600 font-mono text-sm sm:text-base whitespace-nowrap">66 545,11 €</td>
                  <td className="px-1 sm:px-4 py-3 sm:py-4 text-right font-mono font-bold text-sm sm:text-lg whitespace-nowrap" style={{ color: '#c1a16a' }}>399 270,63 €</td>
                </tr>
              </tbody>
            </table>
          </div>
