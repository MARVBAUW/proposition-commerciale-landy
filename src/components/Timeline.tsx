              ...
              <table className="w-full min-w-[600px]">
                ...
                <tbody>
                  ...
                  <tr className="border-t-2" style={{ background: 'linear-gradient(to right, rgba(193, 161, 106, 0.2), rgba(193, 161, 106, 0.1))', borderTopColor: '#c1a16a' }}>
                    ...
                    <td className="px-1 sm:px-4 py-2 sm:py-4 text-center font-mono font-bold text-sm sm:text-lg whitespace-nowrap" style={{ color: '#c1a16a' }}>16-20 mois</td>
                    <td className="px-2 sm:px-4 py-2 sm:py-4 font-semibold text-xs sm:text-sm" style={{ color: '#c1a16a' }}>De la signature à la livraison</td>
                  </tr>
                </tbody>
              </table>
            </div>
